...
temporary_archive="$temporary_dir/${release_name}.zip"
...
(cd "$temporary_dir" && zip -qr "$temporary_archive" "$release_name")
mv "$temporary_archive" "$release_dir/${release_name}.zip"
